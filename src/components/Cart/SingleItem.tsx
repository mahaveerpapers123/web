...
const SingleItem = ({ item }: SingleItemProps) => {
  ...
  const priceNum = useMemo(() => (Number.isFinite(item.price) ? Number(item.price) : 0), [item.price]);
  const subtotal = useMemo(() => priceNum * quantity, [priceNum, quantity]);
  ...
  return (
    <div className="grid grid-cols-12 items-center gap-4 border-t border-gray-3 py-5 px-4 md:px-7.5">
      <div className="col-span-12 md:col-span-5">
        <div className="flex items-center gap-4">
          <div className="flex items-center justify-center rounded-[6px] w-20 h-20 bg-gray-100">
            <img
              src={imageUrl}
          ...
          <div className="min-w-0">
            <h3 className="text-dark hover:text-blue truncate">{item.name}</h3>
            <p className="text-sm text-gray-500 mt-1">Unit: {formatMoney(priceNum)}</p>
          </div>
        </div>
      </div>

      <div className="col-span-6 md:col-span-2">
        <p className="text-dark">{formatMoney(priceNum)}</p>
      </div>
        ...
        <div className="w-max flex items-center rounded-md border border-gray-3">
          ...
          >
            <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20">
              <path d="M3.333 10.0001C3.333 9.53984 3.7061 9.16675 4.16634 9.16675H15.833C16.2932 9.16675 16.6663 9.53984 16.6663 10.0001C16.6663 10.4603 16.2932 10.8334 15.833 10.8334H4.16634C3.7061 10.8334 3.333 10.4603 3.333 10.0001Z" />
            </svg>
          </button>
          ...
          >
            <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20">
              <path d="M3.333 10C3.333 9.5398 3.7061 9.16671 4.16634 9.16671H15.833C16.2932 9.16671 16.6663 9.5398 16.6663 10C16.6663 10.4603 16.2932 10.8334 15.833 10.8334H4.16634C3.7061 10.8334 3.333 10.4603 3.333 10Z" />
      ...
      <div className="col-span-6 md:col-span-1 md:text-right">
        <p className="text-dark font-medium">{formatMoney(subtotal)}</p>
      </div>
