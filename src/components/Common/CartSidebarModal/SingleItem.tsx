    ...
    <div className="grid grid-cols-12 items-center gap-4 border-t border-gray-3 py-5 px-4 md:px-7.5">
      <div className="col-span-12 md:col-span-7">
        <div className="flex items-center gap-4">
          <div className="flex items-center justify-center rounded-[8px] bg-gray-100 w-20 h-20">
            <Image
              src={imageUrl}
          ...
          <div className="min-w-0">
            <h3 className="text-dark font-medium hover:text-blue truncate">{item?.name || ""}</h3>
            <p className="text-sm text-gray-500 mt-1">Unit: {formatMoney(item?.price)}</p>
          </div>
        </div>
      </div>

      <div className="col-span-6 md:col-span-3 md:text-center">
        <p className="text-dark font-medium">{formatMoney(item?.price)}</p>
      </div>
