        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-4 md:grid-cols-3">
          <div>
            ...
            <p className="text-base font-semibold text-gray-900">
              {item.hsn_percentage != null && item.hsn_percentage !== "" ? `${Number(item.hsn_percentage)}%` : "-"}
            </p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Mahaveer</p>
            <p className="text-base font-semibold text-gray-900">{fmtMoney(item.mahaveer_price)}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">MRP</p>
            <p className="text-base font-semibold text-gray-900">{fmtMoney(item.mrp)}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Length</p>
            <p className="text-base font-semibold text-gray-900">{fmtNum(item.length)}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Width</p>
            <p className="text-base font-semibold text-gray-900">{fmtNum(item.width)}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Height</p>
            <p className="text-base font-semibold text-gray-900">{fmtNum(item.height)}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Weight</p>
            <p className="text-base font-semibold text-gray-900">{fmtNum(item.weight)}</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div className="xl:max-w-[870px] w-full">
              <div className="rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6">
                <div className="flex items-center justify-between">
                  <div className="flex flex-wrap items-center gap-4">
                    <p>
                      Showing <span className="text-dark">{startIdx || 0}–{endIdx}</span> of{" "}
              ...
              <div className="flex flex-col space-y-8">
                <div
                  className={
                    productStyle === "grid"
                      ? "grid auto-rows-fr grid-cols-1 gap-x-7.5 gap-y-9 sm:grid-cols-2 lg:grid-cols-3"
                            ...
                            {p === "..." ? (
                              ...
                              <button
                                ...
                                className={`flex py-1.5 px-3.5 duration-200 rounded-[3px] ${
                                  pagination.page === p ? "bg-blue text-white" : "hover:text-white hover:bg-blue"
                                }`}
                              >
                                {p}
                              </button>
