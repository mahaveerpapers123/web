...
const ShopWithSidebar = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const res = await fetch("https://mahaveerbe.vercel.app/api/categories", { credentials: "include" });
  ...
  useEffect(() => {
    const loadProducts = async () => {
      ...
      try {
        ...
        const res = await fetch(`${apiBase}/api/products?${params.toString()}`, { credentials: "include", headers: { Accept: "application/json" } });
        const data = await res.json();
    ...
    loadProducts();
  }, [apiBase, currentPage, pagination.limit, selectedCategory]);
