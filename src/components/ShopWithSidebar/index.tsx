                  ...
                  {products.length > 0 ? (
                    products.map((item) =>
                      productStyle === "grid" ? (
                        <div
                          key={item.id}
                          className="[&_img:not([src*='icon-star'])]:h-[250px] [&_img:not([src*='icon-star'])]:w-auto [&_img:not([src*='icon-star'])]:object-contain h-full"
                        >
